const ageCalculate = () => {
    ...
    dispayResult(days, months, years);
};
...
const getDaysInMonth = (month, year) => {
    ...
    const geetDayInMonth = [31, isLeapYear ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

    return geetDayInMonth[month -1];
};

const dispayResult = (bdate, bMonth, bYear) => {
...
document.querySelector("#calc-age-btn").addEventListener("click", ageCalculate)